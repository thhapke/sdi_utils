...
if __name__ == '__main__':
    ...
    if True :
        print(os.getcwd())
        subprocess.run(["rm", '-r','../../../solution/operators/sdi_utils_operators_' + api.config.version])
        gs.gensolution(os.path.realpath(__file__), api.config, inports, outports)
        solution_name = api.config.operator_name + '_' + api.config.version
        subprocess.run(["vctl", "solution", "bundle",'../../../solution/operators/sdi_utils_operators_' + api.config.version, \
                        "-t", solution_name])
